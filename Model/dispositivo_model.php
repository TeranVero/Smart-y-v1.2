...
class dispositivo_model extends configBD
{
	...
	public function alta_dispositivo(
		...
		$query = sprintf(
			"INSERT INTO dispositivos(nombre,marca,so,pulgadas, alto,
			ancho,grosor,peso, pantalla,tipo_pantalla, tasa_refresco, 
			resolucion, resolucion_a,resolucion_b,ram,
		   	memoria_interna,ampliable_sd, 	seguridad_facial,	seguridad_huella,
		    cam_trasera,caracteristicas_cam,
			flash,estabilizacion_opt,slow_motion,cam_frontal,
		   	cam_otras,lente_teleobjetivo,lente_macro,lente_gran_angular, infrarojos,
			jack,nfc,sensores,usb_tipo,  usb_carga,usb_otg,	usb_masivo,bateria,	conexion, 	pantalla_curva,  resistencia,
			carga_rapida,otros,	fecha,precio,colores) VALUES ('%s','%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s','%s','%s','%s','%s', '%s', '%s', '%s', '%s', '%s','%s', '%s','%s', '%s', '%s','%s','%s','%s', '%s', '%s', '%s', '%s', '%s', '%s','%s','%s','%s','%s', '%s', '%s', '%s', '%s', '%s','%s', '%s', '%s', '%d', '%s')",
			$this->BD->real_escape_string($nombre),$this->BD->real_escape_string($marca),$this->BD->real_escape_string($so),$this->BD->real_escape_string($pulgadas),$this->BD->real_escape_string($alto),$this->BD->real_escape_string($ancho),	$this->BD->real_escape_string($grosor),	$this->BD->real_escape_string($peso),
			$this->BD->real_escape_string($pantalla),$this->BD->real_escape_string($tipo_pantalla),	$this->BD->real_escape_string($tasa_refresco),$this->BD->real_escape_string($resolucion),$this->BD->real_escape_string($resolucion_a),$this->BD->real_escape_string($resolucion_b),	$this->BD->real_escape_string($ram),$this->BD->real_escape_string($memoria_interna),
			$this->BD->real_escape_string($ampliable_sd),$this->BD->real_escape_string($seguridad_facial),	$this->BD->real_escape_string($seguridad_huella),$this->BD->real_escape_string($cam_trasera),	$this->BD->real_escape_string($caracteristicas_cam),$this->BD->real_escape_string($flash),	$this->BD->real_escape_string($estabilizacion_opt),	$this->BD->real_escape_string($slow_motion),
			$this->BD->real_escape_string($cam_frontal),$this->BD->real_escape_string($cam_otras),	$this->BD->real_escape_string($lente_teleobjetivo),	$this->BD->real_escape_string($lente_macro),	$this->BD->real_escape_string($lente_gran_angular),	$this->BD->real_escape_string($infrarojos),	$this->BD->real_escape_string($jack),	$this->BD->real_escape_string($nfc),
			$this->BD->real_escape_string($sensores),	$this->BD->real_escape_string($usb_tipo),	$this->BD->real_escape_string($usb_carga),	$this->BD->real_escape_string($usb_otg),$this->BD->real_escape_string($usb_masivo),$this->BD->real_escape_string($bateria),	$this->BD->real_escape_string($conexion),$this->BD->real_escape_string($pantalla_curva),
			$this->BD->real_escape_string($resistencia),$this->BD->real_escape_string($carga_rapida),$this->BD->real_escape_string($otros),$this->BD->real_escape_string($fecha),
			$this->BD->real_escape_string($precio),	$this->BD->real_escape_string($colores),
		);
